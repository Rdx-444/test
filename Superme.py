...
def genkey():
	try:
		...
		print("\033[0;94m          TELEGRAM ID : @Rdx023")
		print("\033[0;94m          INSTAGRAM : @iam_Rdx_\n\n")
		subprocess.check_output(["am", "start", "https://wa.me/+8801797870616"])
		exit()
	except(IOError):
		rb = rx
		...
		print("\033[0;93m     TOOL PRICE : %s10K"%(H))
		print("\033[0;93m     VALIDITY : %s1 month"%(H))
		print("\033[0;94m             TELEGRAM ID : @iam_Rdx_")
		print("\033[0;94m             INSTAGRAM : @Rdx023\n\n")
		subprocess.check_output(["am", "start", "https://wa.me/+8801797870616"])
		exit()
